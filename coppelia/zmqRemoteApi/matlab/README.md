...
In order to use the directory with the code provided by Coppelia has to be added to the search path.  It can be done in the Matlab configuration dialog or from the command window (or console):
